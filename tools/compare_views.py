...
Usage:  python tools/compare_views.py OLD_URL NEW_URL OUT_DIR [--dpr 1.5]
...
# (name, data-space centre x, y, zoom). Coordinates are the page's projected units.
